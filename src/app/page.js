        ...
        <div className='container flex flex-col gap-10 py-10'>
          ...
          <div className='flex flex-col items-center gap-7'>
            ...
            <nav className="flex items-center gap-6 text-sm">
              <Link
                href="#about"
                className={"font-heading text-muted tracking-wider border-b-2 border-b-transparent transition-colors hover:text-accent"}
              >
                INÍCIO
              </Link>
          ...
          <div className='flex flex-col items-center justify-between gap-8 py-6 border-t sm:flex-row border-muted/40'>
            <p className='text-sm text-center sm:text-left text-muted'>© 2024 M2 Arquitetura. Todos os direitos reservados.</p>
